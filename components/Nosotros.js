...
export default function Nosotros  ()  {	
	return (
	    <div className="container">		
			<div className="mt-10">
				<div className="container">
					<div className="row mb-5" style={{backgroundColor: "lavender"}}>
						...
						<div className="col-12 col-md-8 p-5">
							<div className="mt-2">														
							<h1 className="mb-5 text-start">¿Quiénes somos?</h1>
							<h2 className="primary-color bg-transparent mb-5 text-start">Corresponsabilidad Social Mexicana </h2>						
							<h4 className=" text-start">Somos una organización sin fines de lucro creada con la finalidad de atender las demandas en prevención a las diversas formas de violencia social y desigualdad que viven niñas, niños, adolescentes y mujeres.</h4>				
							</div>
						</div>
					</div>
					<div className="row">													
