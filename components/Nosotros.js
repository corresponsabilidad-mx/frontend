			...
			<div className="mt-10">
				<div className="container">
					...
					<div className="mb-5 p-5" style={{backgroundColor: "lavender", borderRadius: "100px"}}>
						<div className="row">													
							<h3 className="primary-color bg-transparent mb-3 text-center mt-3 p-2">MISIÓN</h3>						
						...
						<div className="row mt-2 mb-5">													
							...
							<div className="line-deco"></div>												
							<p className="mb-5 p-5" style={{fontSize: "1rem"}}>Nuestro propósito es instrumentar acciones que construyan una cultura dirigida a la corresponsabilidad y la paz, desde el desarrollo, la prevención y dignificación de los derechos de niñas, niños, adolescentes y las mujeres.</p>				
						</div>	
					</div>						
				</div>
			</div>		
