...
const Carta = () => {
  return (
    <>
        <div class="caja-cifra">
            <div class="col-sm-5 div-cifra-center">
                <div class="card">
                    <div class="card-body div-cifra linea-vertical">
                    <h4 class="titulo-cifra">Nuestras cifras de impacto</h4>
            ...
            <div class="col-sm-7">
                <div class="card">
                <div class="card-body div-carta">
                <span><BsChatRightQuoteFill className="icono-carta"/>
                        <p class="p-carta">Como Fundadora y a todo el equipo de Corresponsabilidad Social Mexicana A.C., nos complace contar con su visita para conocer y apoyar nuestros proyectos. Agradecemos de antemano cada uno de los esfuerzos que sin duda hizo para llegar hasta aquí.
                        ...
                        <p class="p-carta">Usted y yo podemos cambiar la vida de miles de personas ¡Le damos la bienvenida!</p>

                        <p class="p-carta">Atentamente,</p>

                        <p class="p-carta"><b>Rosa Martha Loría San Martín
